...
let score			= make_live_text ~id:"rt_score" ~class_:["text"] ~style:"top: 18%; left: 50%; font-size: 1.8vw;" ~initial:"Score: 0"
let time			= make_live_text ~id:"rt_time"	~class_:["text"] ~style:"top: 45%; left: 50%; font-size: 1vw;" ~initial:"42:42"
let healed		= single_stat "UI/icons/reproduction" "Healed"	"14" "32" "42"
let dead			= single_stat "UI/icons/dead"					"Dead"		"86" "32" "42"
let healthy		= single_stat "creets/healthy"				"Healthy"	"14" "67" "42"
let sick			=	single_stat "creets/sick"						"Sick"		"38" "67" "42"
let berserk		=	single_stat "creets/berserk"				"Berserk" "62" "67" "42"
let mean			=	single_stat "creets/mean"						"Mean"		"86" "67" "42"
let fps				= make_live_text ~id:"rt_fps"	 ~class_:["text"] ~style:"top: 89%; left: 109%; font-size: 0.65vw; text-align: left;" ~initial:"FPS: 120"
...
let real_time_stats body : unit =
		let overlay =
				div ~a:[a_id "real_time"; a_class ["real_time_bg"]]
					...
					fps.elt]
		in
		Dom.appendChild body (Js_of_ocaml_tyxml.Tyxml_js.To_dom.of_div overlay);
		()
